import { MapPin, Sun, Users, Zap, CheckCircle2, Phone, Mail } from "lucide-react";
...
export default function Story() {
  return (
    <div className="bg-base-100 text-base-content transition-colors duration-300">
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center max-w-4xl" data-aos="fade-down" data-aos-duration="1000">
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight mb-6">
            Injecting boundless momentum and possibilities into the land of China.
          </h1>
          <p className="text-lg text-base-content/80 leading-relaxed max-w-2xl mx-auto">
            From the bustling cities to the sunny countryside, Sunshine is dedicated to democratizing solar energy monitoring for every Chinese household.
          </p>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div className="absolute bottom-6 left-6 right-6 p-4 bg-base-100/90 backdrop-blur-md rounded-xl border border-base-200 shadow-lg">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-xs opacity-70">Powering China's green transition</p>
                        </div>
                    </div>
                </div>
              </div>
            ...
            <div className="space-y-8" data-aos="fade-left" data-aos-duration="1000">
              ...
              <p className="text-base-content/80 text-lg leading-relaxed">
                China is blessed with abundant sunlight across its vast territory. Yet, many homeowners struggle to manage their solar investments effectively.
                <br/><br/>
                We built Sunshine to bridge this gap. Our mission is to provide an intelligent, localized platform that helps Chinese households maximize their energy independence while reducing the national grid burden.
              </p>
      ...
      {/* --- CHINA COVERAGE MAP SECTION --- */}
      <section className="py-24 bg-base-200 relative overflow-hidden">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-12" data-aos="fade-up">Nation-Wide Coverage</h2>
                ...
                <div className="text-left space-y-6">
                    <div className="p-6 bg-base-100/80 backdrop-blur-md rounded-2xl border border-base-200 shadow-sm hover:scale-105 transition-transform cursor-default">
                        <div className="flex items-center gap-3 mb-2">
                            ...
                            <h3 className="font-bold">East China</h3>
                        </div>
                        <p className="text-sm opacity-70">Our headquarters in Shanghai manages over 60% of our grid connections.</p>
                    </div>
                    ...
                    <div className="p-6 bg-base-100/80 backdrop-blur-md rounded-2xl border border-base-200 shadow-sm hover:scale-105 transition-transform cursor-default ml-8">
                        <div className="flex items-center gap-3 mb-2">
                            ...
                            <h3 className="font-bold">South China</h3>
                        </div>
                        <p className="text-sm opacity-70">Rapidly expanding solar farms in Guangdong and Fujian provinces.</p>
                    </div>

                    <div className="p-6 bg-base-100/80 backdrop-blur-md rounded-2xl border border-base-200 shadow-sm hover:scale-105 transition-transform cursor-default">
                        <div className="flex items-center gap-3 mb-2">
                            <MapPin className="text-green-500 w-5 h-5" />
                            <h3 className="font-bold">Western China</h3>
                        </div>
                        <p className="text-sm opacity-70">Supporting large-scale solar farms in Xinjiang and Gansu.</p>
                    </div>
                </div>
      ...
      <section className="py-24 bg-w bg-base-100">
        <div className="container mx-auto px-4">
            <div className="text-center mb-16" data-aos="fade-up">
                <h2 className="text-3xl font-bold">Why China Chooses Us</h2>
            </div>
            <div className="grid md:grid-cols-3 gap-8">
                <ValueCard
                    icon={Users}
                    title="Community First"
                    desc="We prioritize local homeowners and small businesses, offering affordable plans tailored to the Chinese economy."
                    delay="100"
                />
                <ValueCard
                    icon={CheckCircle2}
                    title="Reliability"
                    desc="Our systems are built to handle diverse climates across China, ensuring consistent data year-round."
                    delay="200"
                />
                <ValueCard
                    icon={Zap}
