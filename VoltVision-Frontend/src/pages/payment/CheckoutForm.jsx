...
//       // Re-throw so the EmbeddedCheckout UI knows to show an error screen
//       throw error;
//     }
//   }, [invoiceId, getToken]);

//   return (
//     <div id="checkout" className="w-full max-w-4xl mx-auto my-8 bg-white rounded-lg overflow-hidden border shadow-sm min-h-[400px]">
//       <EmbeddedCheckoutProvider
